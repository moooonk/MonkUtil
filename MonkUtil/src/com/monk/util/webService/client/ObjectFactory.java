 ...
 * generated in the com.monk.util.webService.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStringResponse_QNAME = new QName("http://webService.util.monk.com/", "getStringResponse");
    private final static QName _GetString_QNAME = new QName("http://webService.util.monk.com/", "getString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.monk.util.webService.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.util.monk.com/", name = "getStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.util.monk.com/", name = "getString")
